    ...
    <div className='text-[#fff] bg-gradient-to-r from-[#1d1d1d] to-[#34103D]'>
        ...
        <div className='container mx-auto my-0 flex justify-center items-center'>
          <div className='flex mb-4'>
            <Image className='mr-2' src="/imgpricing/1.png" alt='' width={32} height={32} ></Image>
        ...
        <div className='w-1/3 mx-auto my-6 text-center'>
          <div className="grid grid-cols-5 gap-1">
            ...
            <div className="info-grid">
              <div className='flex justify-center items-center'>
                <Image src="/img/banner2/logo/ban2logo (3).png" alt='' width={50} height={50} ></Image>
              </div>
                <div>
              ...
              <div className="info-grid">
              <div className='flex justify-center items-center'>
                <Image src="/img/banner2/logo/ban2logo (12).png" alt='' width={50} height={50} ></Image>
              </div>
                <div>
              ...
              <div className="info-grid">
              <div className='flex justify-center items-center'>
                <Image src="/img/banner2/logo/ban2logo (9).png" alt='' width={50} height={50} ></Image>
              </div>
                <div>
              ...
              <div className="info-grid">
              <div className='flex justify-center items-center'>
                <Image src="/img/banner2/logo/ban2logo (14).png" alt='' width={50} height={50} ></Image>
              </div>
                <div>
              ...
              <div className="info-grid">
              <div className='flex justify-center items-center'>
                <Image src="/img/banner2/logo/ban2logo (11).png" alt='' width={50} height={50} ></Image>
              </div>
                <div>
        ...
        <div className='w-1/4 mx-auto my-6 text-center'>
          <div className="grid grid-cols-4 gap-1">
            ...
            <div className="info-grid">
              <div className='flex justify-center items-center'>
                <Image src="/img/banner2/logo/ban2logo (6).png" alt='' width={50} height={50} ></Image>
              </div>
                <div>
              ...
              <div className="info-grid">
              <div className='flex justify-center items-center'>
                <Image src="/img/banner2/logo/ban2logo (10).png" alt='' width={50} height={50} ></Image>
              </div>
                <div>
              ...
              <div className="info-grid">
              <div className='flex justify-center items-center'>
                <Image src="/img/banner2/logo/ban2logo (7).png" alt='' width={50} height={50} ></Image>
              </div>
                <div>
              ...
              <div className="info-grid">
              <div className='flex justify-center items-center'>
                <Image src="/img/banner2/logo/ban2logo (2).png" alt='' width={50} height={50} ></Image>
              </div>
                <div>
