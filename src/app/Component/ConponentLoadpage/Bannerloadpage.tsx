    ...
    <div id='Bannerloadpage' className='drop-shadow-2xl'>
        <div className='container mx-auto my-auto flex justify-between relative'>
            <div className="left mt-48">
                <div className='flex'>
                    <Image className='flex mr-2' src="/imgloadpage/ban1.png" alt='' width={32} height={32} ></Image>
            ...
            <div className="right mt-48 absolute right-16 -top-24 drop-shadow-2xl">
                <Image className='rounded-3xl bg-no-repeat bg-center bg-fixed' src="/imgloadpage/ban2.png" alt='' width={600} height={600} ></Image>
            </div>
        </div>
    </div>
  )
