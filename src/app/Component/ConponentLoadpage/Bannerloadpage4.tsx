    ...
    <div id='Bannerloadpage4' className='drop-shadow-2xl'>
        <div className='container mx-auto my-0 flex justify-around'>
            ...
            <div className="left mt-48 text-[#fff] grid grid-cols-5 gap-14">
                ...
                <div className=''>
                    <div>
                        <img className='flex justify-center items-center' src="/img/banner2/logo/ban2logo (1).png" width={150} alt="" />
                        <div>
                ...
                <div className=''>
                    <div>
                        <img className='flex justify-center items-center' src="/img/banner2/logo/ban2logo (2).png" width={150} alt="" />
                        <div>
                ...
                <div className=''>
                    <div>
                        <img className='flex justify-center items-center' src="/img/banner2/logo/ban2logo (3).png" width={150} alt="" />
                        <div>
                ...
                <div className=''>
                    <div>
                        <img className='flex justify-center items-center' src="/img/banner2/logo/ban2logo (4).png" width={150} alt="" />
                        <div>
                ...
                <div className=''>
                    <div>
                        <img className='flex justify-center items-center' src="/img/banner2/logo/ban2logo (5).png" width={150} alt="" />
                        <div>
                ...
                <div className=''>
                    <div>
                        <img className='flex justify-center items-center' src="/img/banner2/logo/ban2logo (6).png" width={150} alt="" />
                        <div>
                ...
                <div className=''>
                    <div>
                        <img className='flex justify-center items-center' src="/img/banner2/logo/ban2logo (7).png" width={150} alt="" />
                        <div>
                ...
                <div className=''>
                    <div>
                        <img className='flex justify-center items-center' src="/img/banner2/logo/ban2logo (8).png" width={150} alt="" />
                        <div>
                ...
                <div className=''>
                    <div>
                        <img className='flex justify-center items-center' src="/img/banner2/logo/ban2logo (9).png" width={150} alt="" />
                        <div>
                ...
                <div className=''>
                    <div>
                        <img className='flex justify-center items-center' src="/img/banner2/logo/ban2logo (10).png" width={150} alt="" />
                        <div>
