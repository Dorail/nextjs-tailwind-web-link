    ...
    <div id='Hero' className='bg-[#1E1E1E] h-1/1'>
        <div className='container mx-auto my-0 text-[#fff] text-center flex flex-col justify-center items-center'>
            ...
            <div className='flex mt-5 gap-8 w-1/8 justify-center'>
                <Image src="/img/hero/spon (1).png" alt='' width={80} height={80}></Image>
                <Image src="/img/hero/spon (2).png" alt='' width={80} height={80}></Image>
                <Image src="/img/hero/spon (3).png" alt='' width={80} height={80}></Image>
                <Image src="/img/hero/spon (4).png" alt='' width={80} height={80}></Image>
                <Image src="/img/hero/spon (5).png" alt='' width={80} height={80}></Image>
                <Image src="/img/hero/spon (6).png" alt='' width={80} height={80}></Image>
                <Image src="/img/hero/spon (7).png" alt='' width={80} height={80}></Image>
            </div>
            <div className='flex mt-5 gap-8 w-1/8 justify-center'>
                <Image src="/img/hero/spon (8).png" alt='' width={80} height={80}></Image>
                <Image src="/img/hero/spon (9).png" alt='' width={80} height={80}></Image>
                <Image src="/img/hero/spon (10).png" alt='' width={80} height={80}></Image>
                <Image src="/img/hero/spon (11).png" alt='' width={80} height={80}></Image>
            </div>
        </div>
    </div>
  )
