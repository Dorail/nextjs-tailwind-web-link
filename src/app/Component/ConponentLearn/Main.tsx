        ...
        <div className='container mx-auto my-0 w-2/3 flex'>
            <div className="left mt-10">
                <div className="text-1">
                    ...
                    <p className='w-3/4 text-[#999] text-lg'>The Rive Renderer draws an unprecedented amount of vectors on screen. Everything animates and deforms without losing quality. Graphics remain crisp and clear regardless of scale, resolution, or device. Best of all, it doesnt require new hardware.</p>
