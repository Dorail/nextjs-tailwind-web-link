    ...
    <div>
        ...
        <div className='container mx-auto my-0 w-2/3 flex'>
            ...
            <div className="right mt-10 mb-10">
                <img className='relative' src="/imglearn/left1.png" width={1500} alt="" />
            </div>
        </div>
        ...
        <div className='container mx-auto my-0 w-2/3 flex justify-between'>
            <div className="left mt-10 mb-10">
                <img className='relative' src="/imglearn/left2.png" width={1500} alt="" />
            </div>
            <div className="right mt-10 mb-10 relative left-56">
                <div className="text-1">
                    <h1 className='text-3xl font-bold my-3'>Perfect text</h1>
                    <p className='w-3/4 text-[#999] text-lg'>You don't have to sacrifice quality for speed – the Rive Renderer delivers both. Text appears perfectly crisp at any size, thanks to analytic antialiasing. You can fill the screen with animated text that looks perfectly sharp, all without making a dent in framerate.</p>
                    {/* <button className='bg-[#272727] rounded-full px-6 py-2 my-3 font-bold'>Read the blog</button> */}
                </div>
            </div>
        </div>
        ...
        <div className='container mx-auto my-0 w-2/3 flex'>
            <div className="left mt-10 mb-10">
                <div className="text-1">
                    ...
                    <br />
                    <p className='w-3/4 text-[#999] text-lg'>The Rive Renderer allows us to support all new features across platforms while maintaining visual fidelity with the Rive Editor. It’s also much faster at rendering Rive content than other platform renderers.</p>
                </div>
            </div>
            <div className="right mt-10 mb-10">
                <img className='relative' src="/imglearn/left3.png" width={1500}  alt="" />
            </div>
        </div>
