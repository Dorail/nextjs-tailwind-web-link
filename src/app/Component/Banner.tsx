        ...
        <div className='container mx-auto my-auto flex justify-between relative'>
            <div className="left mt-48">
                ...
                <div className='grouptext w-2/5'>
                    ...
                    <p className='text-[#999] text-xl'>Use Rive familiar design and animation tools with our ground-breaking State Machine to create interactive content for your products, apps, sites, and games.</p>
                </div> 
